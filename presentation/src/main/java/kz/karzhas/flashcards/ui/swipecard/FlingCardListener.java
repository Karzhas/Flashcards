package kz.karzhas.flashcards.ui.swipecard;
...
public class FlingCardListener implements View.OnTouchListener {
    ...
    private boolean movedBeyondLeftBorder() {
        ...
        Log.d("test", (RECT_LEFT.contains(centerX, centerY) || (centerX < RECT_LEFT.left && RECT_LEFT.contains(0, centerY))) + " left");
    ...
    private boolean movedBeyondRightBorder() {
        int centerX = (int) (frame.getX() + halfWidth);
        int centerY = (int) (frame.getY() + halfHeight);
        Log.d("test", (RECT_RIGHT.contains(centerX, centerY) || (centerX > RECT_RIGHT.right && RECT_RIGHT.contains(RECT_RIGHT.left, centerY))) + " right");
